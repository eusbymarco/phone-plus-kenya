...
window.renderShell = (activePage = '') => {
  ...
  if (header) header.innerHTML = `<a class="logo" href="./index.html">${logo}</a><nav aria-label="Main navigation"><a class="${activePage === 'shop' ? 'active' : ''}" href="./shop.html">Shop phones</a><a class="${activePage === 'about' ? 'active' : ''}" href="./about.html">About</a><a class="${activePage === 'contact' ? 'active' : ''}" href="./contact.html">Contact</a></nav><a class="cart-link" href="./cart.html">Cart <span data-cart-count>0</span></a>`;
